...
<AccordionGroup>
  ...
  <Accordion title="Can I use Frammerce on multiple Framer projects?">
    On **Basic** and **Pro**, one project per license. On **Scale**, unlimited projects.
  </Accordion>

  <Accordion title="Can I build client sites and resell?">
    Yes, on the **Scale** tier. Scale includes a commercial license for unlimited client work.
  </Accordion>
