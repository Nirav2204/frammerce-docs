...
<Card title="Full CMS sync guide" icon="database" href="/cms-sync">
  Field picker, drift detection, scheduling, and what to do when a sync fails.
</Card>
...
<Tip>
On the **Basic** plan, published sites show a small "Powered by Frammerce" badge. Upgrade to **Pro** or **Scale** on the [pricing page](/plans-and-licenses) to remove it.
</Tip>
