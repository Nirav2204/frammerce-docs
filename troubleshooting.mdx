...
description: "Common issues and how to fix them - connect errors, sync drift, missing components, runtime mismatches."
icon: "wrench"
---
...
## Drift detection shows everything as drifted

Drift compares the **product update timestamp** between Shopify and the last sync. If you re-imported your products on Shopify (CSV import, theme migration), all timestamps change at once. Re-sync to clear.
